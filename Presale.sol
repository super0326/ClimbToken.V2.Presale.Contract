...
contract TokenPresale is Ownable {
    ...
    function deposit(uint _amount) public {
        require(_amount > 0 && _amount <= 50000000000000000000000, "MARSToken: Max limit is 500000 BUSD for 5000MARS");
        uint256 allowance = IBEP20(busdAddress).allowance(msg.sender, address(this));
        require(allowance >= _amount, 'MARSToken: insuffient allowance');

        IBEP20(busdAddress).transferFrom(msg.sender, address(this), _amount);
    ...
    function releaseFunds() external onlyOwner {
        ...
        totalDepositedBUSDBalance = totalDepositedBUSDBalance.sub(balance);
    }
